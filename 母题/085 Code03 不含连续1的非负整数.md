...
> **原题链接:** (https://leetcode.cn/problems/non-negative-integers-without-consecutive-ones/)
...
public:
    ...
    int findIntegers(int n) {
        ...
        for (int i = 30; i >= -1; i--) {
            ...
            if ((n & (1 << i)) != 0) {
                ans += cnt[i];
                if (((long long)n & (1LL << (i + 1))) != 0) break;
            }
        }
        return ans;
    }
